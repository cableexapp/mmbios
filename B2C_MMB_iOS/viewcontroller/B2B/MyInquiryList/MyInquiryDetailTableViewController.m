...
- (CGFloat) tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        return 65+0.5+5+30+h1+h2+h3+h4+requestSize.height+5;
    }
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(!cell)
    {
        ...
        else
        {
            ...
            [model_anotherLabel setTextColor:[UIColor lightGrayColor]];
            ...
            for(int i=0;i<6;i++)
            {
                ...
                switch (i) {
                    ...
                    case 4:
                    {
                        ...
                        {
                            [label setFrame:CGRectMake(10, lineView.frame.origin.y+5+30+labelHeight_1, width, 0)];
                        }
                        else
                        {
                            [label setFrame:CGRectMake(10, lineView.frame.origin.y+5+30+labelHeight_1, width, 30)];
                        }
                        break;
                    }
                    ...
                    case 5:
                    {
                        ...
                        if([DCFCustomExtra validateString:thecolor] == NO)
                        {
                            [label setFrame:CGRectMake(10+width, lineView.frame.origin.y+5+30+labelHeight_1, width, 0)];
                        }
                        else
                        {
                            [label setFrame:CGRectMake(10+width, lineView.frame.origin.y+5+30+labelHeight_1, width, 30)];
                        }
            ...
            if([DCFCustomExtra validateString:thePrice] == NO || [thePrice intValue] == 0)
            {
                [label_1 setFrame:CGRectMake(10, lineView.frame.origin.y+5+30+labelHeight_1+labelHeight_2, size_1.width, 0)];
                [pricelabel setFrame:CGRectMake(label_1.frame.origin.x + label_1.frame.size.width+10, label_1.frame.origin.y, size_2.width, 0)];
                [label_2 setFrame:CGRectMake(pricelabel.frame.origin.x + pricelabel.frame.size.width + 10, pricelabel.frame.origin.y, 150, 0)];
            }
            else
            {
                [label_1 setFrame:CGRectMake(10, lineView.frame.origin.y+5+30+labelHeight_1+labelHeight_2, size_1.width, 30)];
                [pricelabel setFrame:CGRectMake(label_1.frame.origin.x + label_1.frame.size.width+10, label_1.frame.origin.y, size_2.width, 30)];
                [label_2 setFrame:CGRectMake(pricelabel.frame.origin.x + pricelabel.frame.size.width + 10, pricelabel.frame.origin.y, 150, 30)];
            }
