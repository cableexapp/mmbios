...
{
    NSDictionary *faceMap = [NSDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"faceKey" ofType:@"plist"]];
  
    NSMutableArray*array = [[NSMutableArray alloc]init];
    for (int i=1; i<106; i++)
    {
        NSString *string = [NSString stringWithFormat:@"%d",i];
       [array addObject:[NSString stringWithFormat:@"[%@]",[faceMap objectForKey:string]]];
    }
