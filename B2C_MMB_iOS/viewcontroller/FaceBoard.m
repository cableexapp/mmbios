...
//            NSLog([_faceMap description]);
        ...
        for (int i = 1; i <= FACE_COUNT_ALL; i++) {
            ...
            NSDictionary *faceMapDic = [NSDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"faceKey" ofType:@"plist"]];
            NSString *string = [NSString stringWithFormat:@"%d",i];
            
            [faceButton setImage:[UIImage imageNamed:[faceMapDic objectForKey:string]]
